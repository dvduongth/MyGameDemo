<GameProjectFile>
  <PropertyGroup Type="Scene" Name="GuiLoading" ID="5e5888c9-b121-4205-a294-648c7e7ce835" Version="2.2.8.0" />
    ...
    <Content>
      ...
      <ObjectData Name="Scene" Tag="23" ctype="GameNodeObjectData">
        ...
        <Children>
          ...
          <AbstractNodeData Name="Text_1" ActionTag="-660888064" Tag="25" IconVisible="False" HorizontalEdge="BothEdge" VerticalEdge="TopEdge" LeftMargin="497.6758" RightMargin="410.3242" TopMargin="617.1519" BottomMargin="1520.8481" FontSize="48" LabelText="GUI LOADING" OutlineSize="1" ShadowOffsetX="2" ShadowOffsetY="-2" ctype="TextObjectData">
          ...
          <AbstractNodeData Name="ndLoadingProgress" ActionTag="2111017531" Tag="26" IconVisible="True" HorizontalEdge="BothEdge" VerticalEdge="BothEdge" LeftMargin="648.2754" RightMargin="593.7246" TopMargin="1260.1003" BottomMargin="947.8997" ctype="SingleNodeObjectData">
            <Size />
            <Children>
              <AbstractNodeData Name="Panel_2_8_3" ActionTag="1351674311" Tag="27" IconVisible="False" LeftMargin="-100.0000" RightMargin="-100.0000" TopMargin="33.0000" BottomMargin="-47.0000" TouchEnable="True" ComboBoxIndex="2" ColorAngle="90.0000" Scale9Width="1" Scale9Height="1" ctype="PanelObjectData">
