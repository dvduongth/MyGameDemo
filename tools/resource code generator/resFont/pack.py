...
g_data_code_file = "ResourceFont.js"
g_resource_input_folder = os.path.join(g_current_folder, g_root_path + 'res/fonts')
    ...
    for folder_child in os.listdir(folder):
        ...
        if os.path.isfile(file_path):
            ...
            if(any(file_ext in ext for ext in g_list_ext)):
                ...
                print "find_resources_from_folder file_ext is not permission: " + file_ext + " with file_path: " + file_path	           
        else:
