function Explosion (game, id) {
	...
	var sndExplosion = [];
	sndExplosion[0] = g_soundEngine.LoadSound("Sound/Explosion_1.mp3", 5, 80);
	sndExplosion[1] = g_soundEngine.LoadSound("Sound/Explosion_2.mp3", 5, 80);
	sndExplosion[2] = g_soundEngine.LoadSound("Sound/Explosion_3.mp3", 5, 80);
	sndExplosion[3] = g_soundEngine.LoadSound("Sound/Explosion_4.mp3", 5, 80);
